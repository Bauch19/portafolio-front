  ...
  return (
    <>
      <header className='flex justify-between items-center px-5'>
        ...
        <nav className="max-[740px]:hidden">
          <div className="container flex items-center justify-center p-6 mx-auto text-gray-600 capitalize">
              <a href="#" className="text-[#DBAB00] border-b-2 border-[#DBAB00] mx-1.5 sm:mx-6">Inicio</a>
              <a href="#sobre-mi" className="border-b-2 border-transparent hover:text-[#DBAB00] transition-colors hover:border-[#DBAB00] mx-1.5 sm:mx-6">Sobre mí</a>
              <a href="#" className="border-b-2 border-transparent hover:text-[#DBAB00] transition-colors hover:border-[#DBAB00] mx-1.5 sm:mx-6">Proyectos</a>
          </div>
        </nav>
      </header>
        ...
        <div className='relative w-full h-[655px] flex justify-center lg:items-center px-[2em]'>
          ...
          <div className='absolute bottom-0 border border-[#DBAB00] text-[#DBAB00] w-[60px] h-[60px] flex justify-center items-center rounded-[50rem]'>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className='text-[#DBAB00] w-7 h-auto' color="#000000" fill="none">
              <path d="M12 20L12 4" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
              <path d="M17 15C17 15 13.3176 20 12 20C10.6824 20 7 15 7 15" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
      </div>
      <div className='relative w-full h-auto' id='sobre-mi'>
        ...
        <div className='w-full flex justify-center'>
          <p className='text-gray-400 max-w-[750px] leading-6 mx-[2rem] text-[20px] font-normal'>
